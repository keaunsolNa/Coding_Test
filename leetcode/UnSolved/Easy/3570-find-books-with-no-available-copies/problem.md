 ...
 **Explanation:**
 ...
 - **The Great Gatsby (book_id = 1):** - Total copies: 3
...
- **1984 (book_id = 3):** - Total copies: 1
- Currently borrowed by David Brown (1 borrower)
- Available copies: 1 - 1 = 0
- Included because available_copies = 0
- **Books not included:** - To Kill a Mockingbird (book_id = 2): Total copies = 3, current borrowers = 2, available = 1
...
- **Result ordering:** - The Great Gatsby appears first with 3 current borrowers
