 ...
 **Explanation:**
 ...
 - **Downtown Tech (store_id = 1):** - Most expensive product: Laptop ($999.99) with quantity 5
...
- **Suburb Mall (store_id = 2):** - Most expensive product: Phone ($699.99) with quantity 3
...
- Has 4 products (≥ 3), so qualifies
- **City Center (store_id = 3):** - Most expensive product: Tablet ($499.99) with quantity 2
...
- **Stores not included:** - Corner Shop (store_id = 4): Only has 2 products (Watch, Band) - doesn't meet minimum 3 products requirement
