 ...
 **Explanation:**
 ...
 - **Alice Johnson (employee_id = 1):** - Has 4 reviews with ratings: 2, 3, 4, 5
...
- **Carol Davis (employee_id = 3):** - Has 4 reviews with ratings: 1, 2, 3, 4
...
- **Bob Smith (employee_id = 2):** - Has 4 reviews with ratings: 3, 2, 4, 5
...
- **Employees not included:** - David Wilson (employee_id = 4): Last 3 reviews are all 4 (no improvement)
