 ...
 **Explanation:**
    ...
    Step `i` Operation `nums1[i]` Updated `nums1`     1 0 Append - [2, 8, 2]   2 0 Decrement Decreases to 1 [1, 8, 2]   3 1 Decrement Decreases to 7 [1, 7, 2]   4 2 Increment Increases to 3 [1, 7, 3]    Thus, after 4 operations `nums1` is transformed into `nums2`.
 ...
 **Explanation:**
    ...
    Step `i` Operation `nums1[i]` Updated `nums1`     1 1 Append - [1, 3, 6, 3]   2 0 Increment Increases to 2 [2, 3, 6, 3]   3 1 Increment Increases to 4 [2, 4, 6, 3]   4 2 Decrement Decreases to 5 [2, 4, 5, 3]    Thus, after 4 operations `nums1` is transformed into `nums2`.
 ...
 **Explanation:**
    ...
    Step `i` Operation `nums1[i]` Updated `nums1`     1 0 Increment Increases to 3 [3]   2 0 Append - [3, 3]   3 1 Increment Increases to 4 [3, 4]    Thus, after 3 operations `nums1` is transformed into `nums2`.
