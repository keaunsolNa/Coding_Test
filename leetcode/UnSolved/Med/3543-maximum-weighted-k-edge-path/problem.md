...
**Difficulty:** Medium | **Tags:** Hash Table, Dynamic Programming, Graph Theory
 ...
 **Explanation:**
 ...
 - There are two paths with `k = 1` edge: - `0 -> 1` with weight `2 < t`.
 ...
 **Explanation:**
 ...
 - There are two paths with k = 1 edge: - `0 -> 1` with weight `6 = t`, which is not strictly less than `t`.
