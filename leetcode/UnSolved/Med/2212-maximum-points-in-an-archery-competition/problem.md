...
**Difficulty:** Medium | **Tags:** Array, Backtracking, Bit Manipulation, Enumeration
...
2. The points are then calculated as follows: 1. The target has integer scoring sections ranging from `0` to `11` **inclusive**.
