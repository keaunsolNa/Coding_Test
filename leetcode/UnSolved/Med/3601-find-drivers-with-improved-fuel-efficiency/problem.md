 ...
 **Explanation:**
 ...
 - **Alice Johnson (driver_id = 1):** - First half trips (Jan-Jun): Feb 15 (120.5/10.2 = 11.81), Mar 20 (200.0/16.5 = 12.12)
...
- **Bob Smith (driver_id = 2):** - First half trips: Jan 10 (100.0/9.0 = 11.11), Apr 15 (250.0/22.0 = 11.36)
...
- **Drivers not included:** - Carol Davis (driver_id = 3): Only has trips in first half (Mar, May)
