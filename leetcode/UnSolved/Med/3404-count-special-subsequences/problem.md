...
**Difficulty:** Medium | **Tags:** Array, Hash Table, Math, Enumeration
 ...
 **Explanation:**
 ...
 - `(p, q, r, s) = (0, 2, 4, 6)`: - This corresponds to elements `(1, 3, 3, 1)`.
 ...
 **Explanation:**
 ...
 - `(p, q, r, s) = (0, 2, 4, 6)`: - This corresponds to elements `(3, 3, 3, 3)`.
- `nums[p] * nums[r] = nums[0] * nums[4] = 3 * 3 = 9`
- `nums[q] * nums[s] = nums[2] * nums[6] = 3 * 3 = 9`
- `(p, q, r, s) = (1, 3, 5, 7)`: - This corresponds to elements `(4, 4, 4, 4)`.
- `nums[p] * nums[r] = nums[1] * nums[5] = 4 * 4 = 16`
- `nums[q] * nums[s] = nums[3] * nums[7] = 4 * 4 = 16`
- `(p, q, r, s) = (0, 2, 5, 7)`: - This corresponds to elements `(3, 3, 4, 4)`.
