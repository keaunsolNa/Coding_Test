 ...
 **Explanation:**
 ...
 - **The Great Gatsby (book_id = 1):** - Has 5 reading sessions (meets minimum requirement)
- Ratings: 5, 1, 4, 2, 5
...
- **1984 (book_id = 3):** - Has 6 reading sessions (meets minimum requirement)
- Ratings: 2, 1, 2, 1, 4, 5
...
- **Books not included:** - To Kill a Mockingbird (book_id = 2): All ratings are 4-5, no low ratings (≤2)
