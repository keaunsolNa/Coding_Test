...
**Difficulty:** Medium | **Tags:** Array, Hash Table, Binary Search, Design, Queue, Ordered Set
 ...
 **Explanation**
 ...
 router.getCount(5, 100, 110); // The only packet with destination 5 and timestamp in the inclusive range `[100, 110]` is `[4, 5, 105]`. Return 1. **Example 2:**
