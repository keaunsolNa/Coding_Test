...
**Difficulty:** Hard | **Tags:** Array, Divide and Conquer, Binary Indexed Tree, Segment Tree
 ...
 **Explanation:**
 ...
 depth `[l, r]` `k` Valid
 `nums[j]` updated
 `nums` Answer     0 [1,0,1,1] [2,4] [10, 100] [1, 1] [0, 1] 1 [0, 1] — 2   1 [2,1,1] [2,4] [10, 100] [1, 1] — — — [2,1] —   2 [1,0,1,0] [2,1] [10, 1] [1, 0] [0, 1] 0 [1] — 1    Thus, the final `answer` is `[2, 1]`.
 ...
 **Explanation:**
 ...
 depth `[l, r]` `k` Valid
 `nums[j]` updated
 `nums` Answer     0 [1,0,2,2] [3, 5, 6] [11, 101, 110] [2, 2, 2] [0, 2] 2 [0, 1, 2] — 3   1 [2,1,4] [3, 5, 6] [11, 101, 110] [2, 2, 2] — — — [3, 4, 6] —   2 [1,1,2,1] [3, 4, 6] [11, 100, 110] [2, 1, 2] [1, 2] 1 [1] — 1   3 [1,0,1,0] [3, 4, 6] [11, 100, 110] [2, 1, 2] [0, 1] 0 [] — 0    Thus, the final `answer` is `[3, 1, 0]`.
 ...
 **Explanation:**
 ...
 depth `[l, r]` `k` Valid
 `nums[j]` updated
 `nums` Answer     0 [1,0,1,1] [1, 2] [1, 10] [0, 1] [0, 1] 1 [1] — 1   1 [2,0,3] [1, 2] [1, 10] [0, 1] — — — [3, 2]     2 [1,0,0,1] [3, 2] [11, 10] [2, 1] [0, 0] 1 [] — 0   3 [1,0,0,2] [3, 2] [11, 10] [2, 1] [0, 0] 2 [0] — 1    Thus, the final `answer` is `[1, 0, 1]`.
...
- `queries[i].length == 3` or `4` - `queries[i] == [1, l, r, k]` or,
- `queries[i] == [2, idx, val]`
- `0 <= l <= r <= n - 1`
- `0 <= k <= 5`
- `0 <= idx <= n - 1`
