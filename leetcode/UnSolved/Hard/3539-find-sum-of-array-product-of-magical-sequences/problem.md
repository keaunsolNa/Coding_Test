...
**Difficulty:** Hard | **Tags:** Array, Math, Dynamic Programming, Bit Manipulation, Combinatorics, Bitmask

## Description

You are given two integers, `m` and `k`, and an integer array `nums`.

 A sequence of integers `seq` is called **magical** if: - `seq` has a size of `m`.
- `0 <= seq[i] < nums.length`
