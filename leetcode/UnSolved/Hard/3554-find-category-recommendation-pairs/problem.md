 ...
 **Explanation:**
 ...
 - **Books-Clothing**: - User 1 purchased products from Books (102) and Clothing (201)
...
- **Books-Electronics**: - User 1 purchased products from Books (102) and Electronics (101)
...
- Total: 3 customers purchased from both categories
- **Clothing-Electronics**: - User 1 purchased products from Clothing (201) and Electronics (101)
...
- Total: 3 customers purchased from both categories
- **Electronics-Sports**: - User 1 purchased products from Electronics (101) and Sports (301)
