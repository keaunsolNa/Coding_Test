...
**Difficulty:** Hard | **Tags:** Array, Union-Find, Graph Theory, Topological Sort, Sorting, Matrix
...
- If two elements `p` and `q` are in the **same row or column**, then: - If `p < q` then `rank(p) < rank(q)`
