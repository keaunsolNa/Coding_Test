...
public class Lessons28 {
	...
	public static void main(String[] args) {
		...
		int answer = lessons28.solution(8, 4, 5);
...
//		단, A번 참가자와 B번 참가자는 서로 붙게 되기 전까지 항상 이긴다고 가정합니다.
        ...
        int answer = 0;
        int temp = 0;
        System.out.println("참가자 수 : " + n);
        System.out.println("참가자 A : " + a);
        System.out.println("경쟁자 B : " + b);
        ...
        while(a != b) {
        	...
        	System.out.println("총 round 수 : " + answer);
        	System.out.println("참가자 수 : " + n);
        	System.out.println("참가자 A : " + a);
        	System.out.println("경쟁자 B : " + b);
