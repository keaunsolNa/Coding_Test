...
public class Lessons58 {
	...
	public static void main(String[] args) {
		...
		String result = lessons58.solution(survey, choices);
...
//		이때, 검사자의 성격 유형 검사 결과를 지표 번호 순서대로 return 하도록 solution 함수를 완성해주세요.
			...
			while(iterValues.hasNext()) {
				...
				if(value == 0) {
					...
					resultMap.put(key1, resultMap.get(key1) + value);
				} else if(value < 0) {
					resultMap.put(key0, resultMap.get(key0) + Math.abs(value));
				}
