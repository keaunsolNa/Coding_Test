...
|:------:|:------:|:----:|:--------:|:-------:|:----:|
| 2,202 | 946 | 199 | 25 | 20 | **3,392** |

`CodingTest/src/` 에 유형별로 모아두었던 백준 풀이는 문제 번호를 확정할 수 있는 항목을 모두 `백준/<티어>/` 로 이관했습니다. 번호를 특정하지 못한 64건(제목 미기재·동명 문제 중복 등)만 `CodingTest/src/` 에 남아 있습니다.
