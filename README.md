...
> 2026-08-19 기준, 문제 폴더 수 집계

### 백준 (티어별 폴더)

| Bronze | Silver | Gold | Platinum | Unrated | 합계 |
|:------:|:------:|:----:|:--------:|:-------:|:----:|
| 2,206 | 951 | 201 | 25 | 20 | **3,403** |

`CodingTest/src/` 에 유형별로 모아두었던 백준 풀이는 문제 번호를 확정할 수 있는 항목을 모두 `백준/<티어>/` 로 이관했습니다. 번호를 특정하지 못한 28건만 `CodingTest/src/` 에 남아 있습니다 — 제목 미기재 13, 동명 문제 중복 12, 미완성 2, 판별 보류 1.
